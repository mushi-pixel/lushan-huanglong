var config = {
    ...
    },
    {
        ...
        image: '',
        slope:true,
        description: '黄龙寺区域大致呈现南北朝向，平均坡度12°，坡形呈保护状，正所谓“千峰环一寺”。黄龙寺区域具备了寺庙选址“宅幽而势阻，地廊而形藏”的特点。点击图层可查看坡度。',
        location: {
            center: [115.960951, 29.552364],
            zoom: 16.5,
            pitch: 0
    ...
    },
    {
        ...
        image: '',
        aspect:true,
        description: '✓ 宗教因素:<br/>用中国佛教寺庙的相地方法来看， 黄龙寺寺宇为 "万山环抱，松杉碧绕"，修篁蔽日， 景色奇幽， "居然胜地"，山清水秀， 所在踞庐山之中， 前对天王峰， 后枕玉屏峰， 西为赐经亭， 下临大溪， 符合佛教寺庙选址传统。<br/>✓外部环境因素:<br/> 外部环境和僧估生活的关系紧密， 佛教山地寺庙的相地选址要求良好的小气候、 背风向阳、 气流通畅、 能排泄雨水、 靠近水源及靠近树林便于采薪、 生产等。 点击图层可查看坡向。',
        location: {
            center: [115.960951, 29.552364],
            zoom: 16.5,
            pitch: 0
    ...
    },
    {
        id: '人文4',
        alignment: 'full',
        title: '新中国成立重新修葺并作为庐山上唯一佛教活动场所，1957年列为江西省文物保护单位',
    ...
    },
    {
        ...
        description: ' 在这片风水宝地之中，三宝树茁壮生长，黄龙寺兴盛发展，闪耀着人与自然和谐共生的光辉。正如佛法的"依正不二”的思想，认为因为人类的贪欲等非理智的错误的行为，侵犯了自然的尊严，最终还是通过自然环境的恶化反过来侵犯了人类自己的尊严。立足于这种自然观，人类必须敬畏自然、尊重自然、顺应自然、保护自然，才能让“天人合一”的中国智慧在新时代焕发出新的生机。 ',
        location: {
            center: [115.95555, 29.4911],
            zoom: 12.92,
            pitch: 39.50,
